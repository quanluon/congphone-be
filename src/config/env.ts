...
export const EnvVariables = {
  ...
  R2_PUBLIC_ENDPOINT: process.env.R2_PUBLIC_ENDPOINT,
  LEGACY_S3_PUBLIC_ENDPOINT: process.env.LEGACY_S3_PUBLIC_ENDPOINT,
  LEGACY_CLOUDFRONT_STORAGE_ENDPOINT:
    process.env.LEGACY_CLOUDFRONT_STORAGE_ENDPOINT ||
    process.env.CLOUDFRONT_STORAGE_ENDPOINT,
