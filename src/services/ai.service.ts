...
7. Image Filtering: Never choose images that prominently show people, faces, hands, animals, pets, or lifestyle/model photography. Prioritize clean product-only packshots on plain or neutral backgrounds.
8. Logic: Ensure the 'basePrice' matches the cheapest variant.
9. Optional Fields: If a field is not found, return null as per the schema (all fields are required but nullable).
`,
      },
      {
        role: "user",
